...
|-----|------|---------|-------------|
| affinity | object | `{}` |  |
| cj.schedule | string | `"0 3 * * *"` |  |
| fullnameOverride | string | `""` |  |
| image.pullPolicy | string | `"IfNotPresent"` |  |
| image.repository | string | `"ghcr.io/camaeel/vault-k8s-helper"` |  |
| image.tag | string | `""` |  |
...
| settings.csrName | string | `"vault-server-tls"` |  |
| settings.tlsSecretName | string | `"vault-server-tls"` |  |
| settings.vaultServices | string | `"vault,*.vault-internal"` |  |
| tolerations | list | `[]` |  |
